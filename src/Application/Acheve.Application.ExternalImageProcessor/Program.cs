...
using Acheve.Application.ExternalImageProcessor.Handlers;
...
namespace Acheve.Application.ExternalImageProcessor
{
    public class Program
    {
        ...
        {
            Console.Title = Constants.Services.ImageProcessService;
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AutoRegisterHandlersFromAssemblyOf<ImageReadyHandler>();
